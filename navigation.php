<header class="ss-navbar" id="header">
	<div class="uk-container uk-container-large">
		...
		<div class="ss-right">
			<a class="wpmenucart-contents empty-wpmenucart-visible" href="http://localhost:3000/Sochyo_Custom/index.php/shop/" title="Start shopping"><i class="wpmenucart-icon-shopping-cart-0" role="img" aria-label="Cart"></i><span class="cartcontents">0 items</span></a>

			<a href="http://localhost:3000/Sochyo_Custom/index.php/my-account/" class="menu__item uk-icon" uk-icon="user">
